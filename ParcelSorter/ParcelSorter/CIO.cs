...
namespace ConsoleIO
{
    public static class CIO
    {
        ...
        {
            return (float)PromptForDouble(message, (double)min, (double)max);
        }
        ...
        public static double PromptForDouble(string message, double min, double max)
        {
            ...
            do
            {
                ...
                {
                    Console.WriteLine("Please enter a valid double between " + min + " and " + max);
                }
        ...
        public static decimal PromptForDecimal(string message, decimal min, decimal max)
        {
            ...
            do
            {
                ...
                {
                    if(d is FormatException || d is ArgumentException)
